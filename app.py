...
def status(n_hours):
    ...
    jobs_df.loc[(jobs_df['link'].str.contains("https://") == False)&(~jobs_df['link'].str.contains("workday")), 'link'] = "https://boards.greenhouse.io" + jobs_df['link']
